...
Status: PHILOSOPHY COMPLETE (§0–§5). STRUCTURE COMPLETE (S1–S4). LIVE RUNS 1-3 DONE.
v9 fixed six defects; v10 demoted the advocate to a shadow; v11 fixes per-key
rate-limit handling. All 25 notes accounted for.
