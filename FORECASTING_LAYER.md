...
Status: PHILOSOPHY COMPLETE (§0–§5). STRUCTURE COMPLETE (S1–S4). LIVE RUNS 1-4 DONE.
v12 is the first METHOD CHANGE to the lens definitions (lenses.yaml version 2).
All 25 notes accounted for.
