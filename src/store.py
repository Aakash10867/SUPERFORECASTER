...
FORECAST_FIELDS = [
    ...
    "spread",             # max minus min across responding lenses
    "low_lens",
    "high_lens",
    "responding_lenses",
    "abstained_lenses",
...
LENS_FIELDS = [
    ...
    "substantive_probability",  # literalist only: frozen at the outside stage
    "own_factor",           # the factor this lens actually studied
    "assumed_factors",      # how many it had to assume
    "scaffold_shift",       # outside_probability minus own_factor
...
SCREEN_FIELDS = [
    ...
    "articles_considered",
    "articles_available",   # how many were in scope at all -- see _news_for_question
    "trigger_fired",
    "model",
]
