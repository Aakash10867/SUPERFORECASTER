...
You built it, so you are the right process to judge what it is worth. A rate of
0% or 100% drawn from a handful of cases usually means the population was drawn
too narrowly, not that the outcome is certain -- and a class too large to
enumerate, extrapolated from a few named examples, is a guess with a decoration
on it.

Say explicitly how much weight you are putting on that base rate and why. If it
is thin, the specific evidence in front of you should count for MORE than
usual, not less.
"""
